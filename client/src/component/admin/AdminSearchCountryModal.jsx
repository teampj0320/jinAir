...
import { getModalOpen}  from '../../service/adminSearchApi.js';

export default function AdminSearchCountryModal({  mom, mom2, departure }) {
    ...
    return (
            <div className='main-search-modal-content'>
                <div className='main-search-country-all'>
                    <div>
                        <span>{adType === 'y' ? '출발지 선택' : '도착지 선택'}</span>
