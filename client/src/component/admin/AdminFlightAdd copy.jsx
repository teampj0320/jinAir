...
import { getModalOpen, getCalendar3, getStartDate, getType, getDeparture, getArrive} from '../../service/adminSearchApi.js';
    ...
    <div className='admin-airlist-content'>
      <form onSubmit={handleSubmit}>
        ...
        <div className='admin-add-air'>
          {modalOpen && (<AdminSearchCountryModal mom={mom} departure={departure}/> )}
          ...
          <div className='add-flight-info'>
            ...
            <div className='add-info1'>
              <div className='add-input-wrapper'>
                ...
                <input type="text" className='add-fnum1' readOnly placeholder={planeN === 'default' ? '' :'188 좌석'}/>
              </div>
              <div className='add-input-wrapper'>
                <span className="prefix-label">Basic Seat</span>
                <input type="text" className='add-fnum1' readOnly placeholder={planeN === 'default' ? '' :'180 좌석'}/>
              </div>
              <div className='add-input-wrapper'>
                <span className="prefix-label prem">Premium Seat</span>
                <input type="text" className='add-fnum1' readOnly placeholder={planeN === 'default' ? '' :'8 좌석'}/>
              </div>
            </div>
