...
export default function BoolingPaymentAgerr() {
                    ...
                    <span className="check-icon-warp">
                        <label onClick={handleCheckAll}>
                            {openStates.additionall
                                ? <FaSquareCheck size="28" className="check-icon" /> : <FaRegSquareCheck size="25" className="check-icon" />
                            }
                        </label>
                            ...
                            <span className="check-icon-warp">
                                <label onClick={() => toggleList("addition1")}>
                                    {openStates.addition1
                                        ? <FaSquareCheck size="25" className="check-icon" /> : <FaRegSquareCheck size="25" className="check-icon" />
                                    }
                                </label>
                                <label>동의 하기</label>
                            </span>
