                        ...
                        </ul>
                        {
                            resData ?  resData.map((item) =>  (
                                <section className='myRes-tbody'>
                                    ...
                                    <div>{dayjs(item.res_date).format('YYYY.MM.DD (ddd)')}</div>
                                    <div>왕복</div>
                                    <div> {item.passenger_name ? JSON.parse(item.passenger_name).length : 0}명</div>
                                    {/* 여정 출발일 기준 디데이 계산 */}
                                    <div>확약
                                        <p>(D-{dayjs(item.departure_date).diff(dayjs(), 'day')})</p>
                                    </div>
                                </section>
