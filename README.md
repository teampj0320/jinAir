...
## 📄개요
- 항공권 예매 서비스인 <B>진에어</B>를 벤치마킹하여 구현한 팀 프로젝트입니다.
...
📁 챗봇
- 우측하단 사이드 바 아이콘을 통해 항공편, 예약 조회
- 예약 조회 후 메인페이지 반영 가능
  
📁 환율
- 우측하단 사이드 바 아이콘을 통해 달러, 엔화, 유로화 환율 계산 기능
...
- 관심지역 설정
- 고객 문의 확인
- EmailJS 라이브러리를 통한 탑승권 메일 발송 (탑승 당일 활성화)

📁 맞춤항공권
- 사용자가 설정한 관심지역을 기반으로, 가까운 날짜의 항공편을 맞춤 추천
- 휴양, 도시, 해변 등 카테고리별로 근시일 내 항공편을 추천하여 선택의 편의성 제공
